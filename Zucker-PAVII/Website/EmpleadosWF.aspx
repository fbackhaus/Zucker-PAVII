...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolderPrincipal" Runat="Server">
   ...
   <div class="form-group" id="divGrilla" runat="server">
        ...
        <asp:GridView ID="gvEmpleados" AutoGenerateColumns="False" runat="server" OnSelectedIndexChanged="gvEmpleados_SelectedIndexChanged" CssClass="table table-striped table-bordered table-condensed">
            <Columns>
