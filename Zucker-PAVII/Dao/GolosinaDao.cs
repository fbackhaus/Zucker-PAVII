...
namespace Dao
{
    public class GolosinaDao
    {
        ...
        public static List<String> cargarComboTipo()
        {
            ...
            SqlCommand cmd = new SqlCommand();
            cmd.Connection = cn;
            cmd.CommandText = "Select id_tipo_golosina, nombre FROM Tipo_Golosina";
            SqlDataReader dr = cmd.ExecuteReader();
            while(dr.Read())
            {
                listaCampos.Add(dr["nombre"].ToString());
            }
            dr.Close();
            cn.Close();
            return listaCampos;
        ...
        public static List<String> cargarComboMarca()
        {
            List<String> listaCampos = new List<String>();
            SqlConnection cn = new SqlConnection();
            cn.ConnectionString = @"Data Source=ARMLGLOCCHIPI\SQLEXPRESS;Initial Catalog=BD_Golosinas;Integrated Security=True";
            ...
            SqlCommand cmd = new SqlCommand();
            cmd.Connection = cn;
            cmd.CommandText = "Select id_marca, nombre FROM Marca";
            SqlDataReader dr = cmd.ExecuteReader();
            while (dr.Read())
            {
                listaCampos.Add(dr["nombre"].ToString());
        ...
        {
            Golosina g = null;
            SqlConnection cn = new SqlConnection(@"Data Source=ARMLGLOCCHIPI\SQLEXPRESS;Initial Catalog=BD_Golosinas;Integrated Security=True");
            cn.Open();
            SqlCommand cmd = new SqlCommand();
            cmd.Connection = cn;
